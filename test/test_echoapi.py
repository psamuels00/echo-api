...
class TestSimpleResponse(TestEchoServer):
    ...
    def test_content_only(self):
        self.case('http://127.0.0.1:5000/labs/Illuminati?_echo_response={ "id": 4 }', 200, '{ "id": 4 }')

    def test_content_only_after_newline(self):
        self.case(
            """http://127.0.0.1:5000/labs/Illuminati?_echo_response=
                     { "id": 4 }""",
            200,
            '{ "id": 4 }',
        )
    ...
    def test_status_code_and_content(self):
        self.case('http://127.0.0.1:5000/labs/Illuminati?_echo_response=201 { "id": 4 }', 201, '{ "id": 4 }')
    ...
    def test_extra_fields(self):
        self.case(
            'http://127.0.0.1:5000/samples/45?_echo_response=200 { "id": 45, "date": null }&pet=dog',
            200,
            '{ "id": 45, "date": null }',
        )
    ...
    def test_plain_text_response(self):
        ...
        self.case(f"http://127.0.0.1:5000/labs/Illuminati?_echo_response=200 {text}", 200, text)


class TestResponseTextExplicit(TestEchoServer):
    def test_text_content(self):
        self.case('http://127.0.0.1:5000/labs/Illuminati?_echo_response=201 text:{ "id": 4 }', 201, '{ "id": 4 }')

    def test_text_content_after_newline(self):
        self.case(
            """http://127.0.0.1:5000/labs/Illuminati?_echo_response=201
                     text:{ "id": 4 }""",
            201,
            '{ "id": 4 }',
        )
...
class TestResponseFile(TestEchoServer):
    def test_file_content(self):
        self.case(
            "http://127.0.0.1:5000/samples?_echo_response=200 file:test/ok.txt",
            200,
            RulesTemplate().load_file("test/ok.txt"),
        )

    def test_file_content_with_trailing_newlines(self):
        self.case(
            "http://127.0.0.1:5000/samples?_echo_response=200 file:test/trail_nl.txt",
            200,
            RulesTemplate().load_file("test/trail_nl.txt"),
        )
    ...
    def test_only_resolve_echo_files(self):
        self.case("http://127.0.0.1:5000/?_echo_response=200 file:test/the_color_is.echo", 200, "The color is green.\n")
        self.case(
            "http://127.0.0.1:5000/?_echo_response=200 file:test/the_color_is.txt", 200, "The color is {color}.\n"
        )

    def test_evaluate_echo_files(self):
        self.case(
            "http://127.0.0.1:5000/?_echo_response=200 file:test/the_color_is_path.txt",
            200,
            "PATH: /./ The color is {color}.\nPATH: /./ {color} is the color.\n",
        )
        self.case(
            "http://127.0.0.1:5000/?_echo_response=200 file:test/the_color_is_path.echo", 200, "The color is green.\n"
        )
...
class TestParameters(TestEchoServer):
    def test_named_path_parameters(self):
        self.case(
            'http://127.0.0.1:5000/samples/id:73/material:wood?_echo_response=200 text:{ "id": {id}, "material": "{material}" }',
            200,
            '{ "id": 73, "material": "wood" }',
        )
    ...
    def test_other_url_parameters(self):
        self.case(
            'http://127.0.0.1:5000/samples/id:75?_echo_response=200 text:{ "id": {id}, "color": "{color}" }',
            200,
            '{ "id": 75, "color": "green" }',
        )
    ...
    def test_json_value(self):
        self.case(
            'http://127.0.0.1:5000/samples/id:77?_echo_response=200 text:{ "id": {id}, "dog": "{json.pet.dog.name}" }',
            200,
            '{ "id": 77, "dog": "Fido" }',
        )
...
class TestParametersInFileName(TestEchoServer):
    def setUp(self):
        ...
        delay, headers, status, content = RulesTemplate("", file).resolve(
            headers=dict(), params=dict(id=74, color="green", age=7), json=Box({"pet": {"dog": {"name": "Fido"}}})
        )
    ...
    def test_parameterized_file_name(self):
        self.case(
            "http://127.0.0.1:5000/samples/id:74?_echo_response=200 file:test/samples/get/green/Fido/{id}.json",
            200,
    ...
    def test_other_parameterized_file_name(self):
        self.case(
            "http://127.0.0.1:5000/samples/id:74?_echo_response=200 file:test/samples/get/{color}/Fido/74.json",
            200,
            self.expected_content,
        )
    ...
    def test_json_parameterized_file_name(self):
        self.case(
            "http://127.0.0.1:5000/samples/id:74?_echo_response=200 file:test/samples/get/green/{json.pet.dog.name}/74.json",
            200,
            self.expected_content,
        )
    ...
    def test_all_types_of_param(self):
        self.case(
            "http://127.0.0.1:5000/samples/id:74?_echo_response=200 file:test/samples/get/{color}/{json.pet.dog.name}/{id}.json",
            200,
            self.expected_content,
        )
...
class TestSelectionRules(TestEchoServer):
    def test_no_criteria(self):
        self.case('http://127.0.0.1:5000/it?_echo_response=200 { "name": "foo" }', 200, '{ "name": "foo" }')

    def test_rule_with_file_content(self):
        self.case(
            "http://127.0.0.1:5000/it?_echo_response=200 PARAM:color/green/file:test/ok.txt",
            200,
            RulesTemplate().load_file("test/ok.txt"),
        )
    ...
    def test_whitespace_not_allowed_in_selector(self):
        self.case(
            "http://127.0.0.1:5000/it?_echo_response=200 PARAM :color /green/ text:Good",
            200,
            "PARAM :color /green/ text:Good",
        )

    def test_match_first_param(self):
        self.case(
            """http://127.0.0.1:5000/it?_echo_response=200
    ...
    def test_match_path_param(self):
        self.case(
            """http://127.0.0.1:5000/shape:square?_echo_response=200
    ...
    def test_match_path(self):
        self.case(
            """http://127.0.0.1:5000/insect/ant?_echo_response=200
...
class TestRuleMarkers(TestEchoServer):
    ...
    def test_vertical_bar2(self):
        ...
        self.case(f"http://127.0.0.1:5000/labs/Illuminati?_echo_response=200 @ text:{text}", 200, text)
...
class TestParameterizeEverything(TestEchoServer):
    def test_response_status_code_evaluated(self):
        self.case(
            """http://127.0.0.1:5000/code:210?_echo_response={code}
                     text:gorilla""",
            210,
            "gorilla",
        )
    ...
    def test_selector_type_evaluated(self):
        self.case(
            """http://127.0.0.1:5000/type:PARAM?_echo_response=200
    ...
    def test_selector_target_evaluated(self):
        self.case(
            """http://127.0.0.1:5000/param:color?_echo_response=200
    ...
    def test_match_pattern_evaluated(self):
        self.case(
            """http://127.0.0.1:5000/alt:light-green?_echo_response=200
...
class TestNestedFiles(TestEchoServer):
    def test_simple_nested_response_files(self):
        self.case(
            "http://127.0.0.1:5000/samples?_echo_response=200 file:test/kingdom/animalia.echo", 200, "I'm a dog!\n"
        )

    def test_match_param_on_nested_file(self):
        self.case(
            "http://127.0.0.1:5000/samples/id:72?_echo_response=200 file:test/match_param.echo",
            200,
            '{ "color": "green" }\n',
        )
    ...
    def test_double_hop_matching(self):
        self.case(
            "http://127.0.0.1:5000/samples/id:72?_echo_response=200 file:test/match_json.echo",
            200,
            '{ "color": "green" }\n',
        )
    ...
    def test_continue_after_no_match_on_nested_file(self):
        self.case(
            "http://127.0.0.1:5000/samples?_echo_response=200 file:test/continue_after_no_match.echo",
            200,
            '{ "color": "green" }\n',
        )

    def test_continue_after_no_match_on_nested_file_no_selector(self):
        self.case("http://127.0.0.1:5000/samples?_echo_response=200 file:test/no_match_file_first.echo", 200, "ok\n")

    def test_no_rule_selected(self):
        self.case("http://127.0.0.1:5000/samples?_echo_response=200 file:test/no_match.echo", 200, "")
...
class TestCommentsInFiles(TestEchoServer):
    def test_comments_in_file(self):
        self.case("http://127.0.0.1:5000/samples?_echo_response=200 file:test/comments.echo", 200, "porcupine\n")

    def test_comment_before_rules_in_file(self):
        self.case(
            "http://127.0.0.1:5000/samples?_echo_response=200 file:test/comment_before_rules.echo",
            200,
            "the sky is blue\n",
        )
    ...
    def test_comment_after_file_rule_in_file(self):
        self.case(
            "http://127.0.0.1:5000/samples?_echo_response=200 file:test/comment_after_file.echo", 200, "got match?\n"
        )

    def test_comment_after_text_rule_in_file(self):
        self.case(
            "http://127.0.0.1:5000/samples?_echo_response=200 file:test/comment_after_text.echo",
            200,
            "Bananas are fun.\n",
        )
    ...
    def test_comment_in_middle_of_text_rule_in_file(self):
        self.case(
            "http://127.0.0.1:5000/samples?_echo_response=200 file:test/comment_in_middle_of_text.echo",
            200,
            "Bananas are fun.\nPeaches are fun too!\n",
        )
...
class TestDelayOption(TestEchoServer):
    ...
    def test_global_delay_only(self):
        self.delay_case(
            ...
            delay=500ms PARAM:color /green/ fig""",
            200,
            "fig",
        )
    ...
    def test_rule_specific_delay_only(self):
        self.delay_case(
            300,
            """http://127.0.0.1:5000?_echo_response=
            PARAM:color /green/ delay=300ms fig""",
            200,
            "fig",
        )
    ...
    def test_global_and_rule_specific_delay(self):
        self.delay_case(
            300,
            """http://127.0.0.1:5000?_echo_response=
            delay=500ms PARAM:color /green/ delay=300ms fig""",
            200,
            "fig",
        )
    ...
    def test_rule_specific_with_file_contents(self):
        self.delay_case(
            300,
            """http://127.0.0.1:5000?_echo_response=
            PARAM:color /green/ delay=300ms file:test/delay/simple.echo""",
            200,
            "fig\n",
        )
    ...
    def test_global_delay_override_by_nested_rule(self):
        self.delay_case(
            200,
            """http://127.0.0.1:5000?_echo_response=
            delay=500ms file:test/delay/override.echo""",
            200,
            "mango\n",
        )
    ...
    def test_rule_specific_delay_override_by_nested_rule(self):
        self.delay_case(
            200,
            """http://127.0.0.1:5000?_echo_response=
            PARAM:color /green/ delay=500ms file:test/delay/override.echo""",
            200,
            "mango\n",
        )
    ...
    def test_override_nested_first_line(self):
        self.delay_case(
            200,
            """http://127.0.0.1:5000?_echo_response=
            delay=500ms file:test/delay/override_first_line.echo""",
            200,
            "mango\n",
        )
    ...
    def test_override_nested_global_for_selection(self):
        self.delay_case(
            100,
            """http://127.0.0.1:5000?_echo_response=
            delay=500ms file:test/delay/global_for_selection.echo""",
            200,
            "mango\n",
        )
    ...
    def test_override_in_selection(self):
        self.delay_case(
            200,
            """http://127.0.0.1:5000?_echo_response=
            delay=500ms file:test/delay/override_in_selection.echo""",
            200,
            "mango\n",
        )
...
class TestStatusCodeOverrides(TestEchoServer):
    ...
    def test_override_status_code_in_nested_file(self):
        self.case(
            """http://127.0.0.1:5000/it?_echo_response=
                     file:test/delay/override_status_code.echo""",
            201,
            "turkey\n",
        )
    ...
    def test_override_status_code_in_nested_file_selection(self):
        self.case(
            """http://127.0.0.1:5000/it?_echo_response=
                     file:test/delay/override_status_code_in_selection.echo""",
            201,
            "turkey\n",
        )
...
class TestSpaceRemoval(TestEchoServer):
    ...
    def test_retain_space_on_first_line_of_file_content(self):
        self.case(
            "http://127.0.0.1:5000/?_echo_response=200 file:test/beginning_with_space.echo",
            200,
            "    Four spaces.\nThen none.\n",
        )
